...
public class SaveAndLoadsave : MonoBehaviour
{
    private string DATA_PATH = "/AumTest.txt" ;  //สร้างตัวแปรชื่อว่า DATA_PATH เพื่อเก็บที่อยู่ไฟล์เกมที่บันทึก
    ...
    void SaveData()
    {
        ...
        try      
        {
            ...
            Player me = new Player("Aum",100.0f,99); //สร้างผู้เล่นใหม่(Name : Boat ,HP : 100 , Level : 99 ) เอาไว้ในตัวแปร me
